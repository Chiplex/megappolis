...
REPLACE INTO `pages` (`id`, `app_id`, `controller`, `action`, `name`, `type`, `icon`, `page_id`, `created_at`, `updated_at`) VALUES
	...
	(3, 1, 'page', 'index', 'Páginas', 'submenu', 'fa fa-file', 11, '2021-04-05 16:04:15', '2021-04-12 16:06:20'),
	(4, 1, 'permission', 'index', 'Permisos', 'submenu', 'fa fa-user-shield', 11, '2021-04-05 16:05:33', '2021-04-12 16:06:47'),
	(5, 1, 'app', 'index', 'Apps', 'submenu', 'fa fa-city', 11, '2021-04-05 16:05:59', '2021-04-12 16:09:37'),
	(6, 1, 'app', 'register', 'Registro de Roles', 'page', NULL, 0, '2021-04-05 16:06:26', '2021-04-05 16:06:26'),
	(7, 1, 'role', 'index', 'Roles', 'submenu', 'fa fa-user-tag', 11, '2021-04-05 16:06:58', '2021-04-12 16:07:03'),
	(8, 1, 'role', 'register', 'Registro de rol', 'page', NULL, 0, '2021-04-05 16:07:38', '2021-04-05 16:07:38'),
	(9, 1, 'user', 'index', 'Usuarios', 'submenu', 'fa fa-user-friends', 11, '2021-04-05 16:16:57', '2021-04-12 16:07:17'),
	(10, 1, 'user', 'register', 'Registro de usuario', 'page', NULL, 0, '2021-04-05 16:17:38', '2021-04-05 16:17:38'),
	(11, 1, 'home', 'index', 'Core', 'menu', NULL, 0, '2021-04-05 19:37:35', '2021-04-05 19:37:35'),
	(12, 2, 'home', 'index', 'Yeipi', 'menu', NULL, 0, '2021-04-05 20:10:50', '2021-04-05 20:10:50'),
	(13, 1, 'people', 'index', 'Personas', 'submenu', 'fa fa-users', 11, '2021-04-12 16:09:09', '2021-04-12 16:09:09'),
	(14, 1, 'people', 'register', 'Registro de Personas', 'page', NULL, 0, '2021-04-12 16:10:50', '2021-04-12 16:10:50'),
	(15, 2, 'pedir', 'index', 'Pedir', 'submenu', 'fa fa-cart-plus', 12, '2021-04-12 16:22:30', '2021-04-12 16:22:30'),
	(16, 2, 'entregar', 'index', 'Entregas', 'submenu', 'fa fa-truck-loading', 12, '2021-04-12 16:26:45', '2021-04-12 16:26:45'),
	(17, 2, 'proveer', 'index', 'Proveer', 'submenu', 'fa fa-project-diagram', 12, '2021-04-12 16:28:21', '2021-04-12 16:28:21'),
	(18, 2, 'pedir', 'register', 'Detalles de pedido', 'page', NULL, 0, '2021-04-13 23:08:51', '2021-04-13 23:08:51'),
	(19, 2, 'detail', 'register', 'Registro de Detalles', 'submenu', NULL, 12, '2021-04-15 22:57:15', '2021-04-15 23:12:28'),
	(20, 2, 'entregar', 'register', 'Registro de Pedido', 'page', NULL, 0, '2021-04-16 19:32:31', '2021-04-16 19:32:31'),
	(21, 2, 'shop', 'index', 'Proveedores', 'submenu', 'fa fa-star', 12, '2021-04-16 21:55:21', '2021-04-16 21:55:21'),
	(22, 2, 'shop', 'register', 'Registro de Proveedor', 'page', NULL, 0, '2021-04-16 21:56:08', '2021-04-16 21:56:08'),
	(23, 2, 'delivery', 'index', 'Deliveries', 'page', 'fa fa-user-circle', 0, '2021-04-17 00:32:30', '2021-04-17 00:32:30'),
	(24, 2, 'contract', 'index', 'Contratos', 'submenu', NULL, 12, '2021-04-17 00:52:41', '2021-04-17 00:53:05'),
	(25, 2, 'contract', 'register', 'Registro de contrato', 'page', NULL, 0, '2021-04-17 00:53:51', '2021-04-17 00:53:51'),
	(26, 2, 'home', 'register', 'Registro de Información básica', 'new', NULL, 0, '2021-10-27 22:33:01', '2021-10-28 01:30:16'),
	(27, 2, 'pedir', 'iniciar', 'Inicio de ubicación de pedido', 'new', NULL, 0, '2021-10-28 01:27:47', '2021-10-28 01:48:56'),
	(28, 2, 'pedir', 'history', 'Histórico de Pedidos', 'page', NULL, 0, '2021-10-28 01:33:36', '2021-11-04 01:06:02'),
	(29, 2, 'proveer', 'iniciar', 'Inicio de ubicación de provisión', 'new', NULL, 0, '2021-10-28 01:48:19', '2021-10-28 01:49:16'),
	(30, 2, 'proveer', 'register', 'Registro de Productos', 'new', NULL, 0, '2021-10-28 01:50:26', '2021-10-28 01:51:17'),
	(31, 2, 'product', 'index', 'Productos', 'menu', NULL, 12, '2021-11-04 01:41:02', '2021-11-04 01:44:34');
...
-- Volcando datos para la tabla megappolis.yeipi_customers: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla megappolis.yeipi_details: ~1 rows (aproximadamente)
REPLACE INTO `yeipi_details` (`id`, `order_id`, `descripcion`, `cantidad`, `precio`, `created_at`, `updated_at`, `fechaConseguido`, `fechaNoConseguido`, `stock_id`) VALUES
	(1, 1, '', 1, 0.6000, '2021-11-05 02:00:28', '2021-11-05 02:00:28', NULL, NULL, 3);
...
-- Volcando datos para la tabla megappolis.yeipi_orders: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla megappolis.yeipi_provider: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla megappolis.yeipi_shops: ~1 rows (aproximadamente)
...
REPLACE INTO `yeipi_stocks` (`id`, `product_id`, `shop_id`, `precio`, `stock`, `medida`, `created_at`, `updated_at`) VALUES
	...
	(3, 1, 1, 0.60, 20.00, 'libra', '2021-11-05 01:18:54', '2021-11-05 01:18:54'),
	(4, 2, 1, 0.60, 5.00, 'libraa', '2021-11-05 01:19:04', '2021-11-05 01:19:04'),
