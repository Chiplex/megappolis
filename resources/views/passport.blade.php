...
{!! Form::open($form) !!}
    ...
    @include('form.input-group.date', ['options' => collect(['name' => 'birth', 'placeholder' => 'Fecha de Nacimiento', 'required' => true, 'title' => 'Fecha de Nacimiento'])])
    ...
    @include('form.input-group.text', ['options' => collect(['name' => 'document', 'placeholder' => 'Numero de Documento CI / DNI', 'required' => true])])
